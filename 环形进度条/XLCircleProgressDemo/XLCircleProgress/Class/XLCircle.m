...
-(void)buildLayout
{
    ...
    backLayer.strokeColor  = [UIColor colorWithRed:103.0/255.0f green:103.0/255.0f blue:103.0/255.0f alpha:1].CGColor;
    ...
    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[RGB(99, 222, 0) CGColor],(id)[RGB(0, 152, 0) CGColor], nil]];
