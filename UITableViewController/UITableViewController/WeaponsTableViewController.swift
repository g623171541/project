 ...
 */
    ...
    //数据源
    var weapons = [Weapon(name: "AUG", type: "自动步枪", origin: "奥地利", image: "aug", favorite: false, bullet: 7.62, mv: 900, text: """
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let shareAction = UIContextualAction(style: .normal, title: "share") { (_, _, completion) in
            ...
            let img = UIImage(named: self.weapons[indexPath.row].image)!
    ...
    override func tableView(_ tableView: UITableView, leadingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        favAction.image = self.weapons[indexPath.row].favorite == true ? #imageLiteral(resourceName: "fav") : #imageLiteral(resourceName: "unfav")
